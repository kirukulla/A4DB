...
public class DimDataGenerator {
	...
	public DimDataGenerator(String dbName, String datasetName, int segmentCount, int recordCount, int distributions, int encoding, int segmentNo, boolean createSegment, int startRecordId) throws Exception{
	...
	public static void main(String[] args) {
		...
		try {
			DimDataGenerator tdg = 
					new DimDataGenerator(dbName, filename, segmentCount, recordCount, 31, encoding, segmentNo, true, 0);
